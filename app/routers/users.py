...
from app.services.image_uploads import delete_profile_image, process_profile_image
...
@router.patch("/{user_id}/picture", response_model=UserMe)
...
@router.delete("/{user_id}/picture", response_model=UserMe)
